<template>
	<view class="team-list-container">
		...
		<view class="team-list-container-list">
			<view class="team-list-container-list-item" v-for="item in [1,2,3,4,5,6,7,8,9,0,11]" :key="item">
				<view class="team-list-container-list-item-left">
					<image class="team-list-container-list-item-left-avatar" src="/static/logo.png" mode="aspectFit">
					</image>
					<image class="team-list-container-list-item-left-gender" src="/static/chat/ic_boy@3x.png"
				...
				<view class="team-list-container-list-item-right">
					<view class="team-list-container-list-item-right-title">
						...
						<image class="team-list-container-list-item-right-title-1" src="/static/chat/ic_vip@3x.png"
							mode="aspectFit"></image>
						<image class="team-list-container-list-item-right-title-2" src="/static/chat/ic_verified@3x.png"
							mode="aspectFit"></image>
					</view>
					<view class="team-list-container-list-item-right-des">
						世界上所有的相遇都是一次机会…世界上所有的相遇都是一次机会…
					</view>
				</view>
			</view>
		</view>
		...
		<view class="team-list-container-bottom">
			<view class="team-list-container-bottom-btn">
				退出团队
			</view>
		</view>
	</view>

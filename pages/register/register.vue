	...
	<view class="register-page">
		...
		<form @submit="onSMRegister" class="register-page-form">
			<view class="register-page-form-view">
				...
				<view class="register-page-group">
					<input placeholder="请输入昵称" maxlength="10" name="realname"></input>
				</view>
				...
				<view class="register-page-group">
					<input placeholder="请输入职业" maxlength="50" name="profession"></input>
				</view>
				<view class="register-page-group">
					<input placeholder="紧急联系人" maxlength="10" name="emergencyContact"></input>
				</view>
				<view class="register-page-group">
		...
		methods: {
			...
			onSMRegister(e){
				...
				if(formData.emergencyContactPhone){
					rule.push({name:'emergencyContactPhone',checkType:'phoneno',errorMsg:'请输入正确的手机号码'});
				}
				rule.push({name:"agree",checkType:'notnull',checkRule:'',errorMsg:'请阅读并选择遵守协议'});
